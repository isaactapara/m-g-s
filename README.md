...
![M&G's Logo](/frontend/brand-logo-v2.png)
...
- **Zero-Overhead Reactivity**: Built on a custom **Observable State Manager** (`src/core/store.js`), delivering framework-like reactivity without the performance penalties of a heavy VDOM.
...
- **⚡ Quick Billing**: A predictive terminal ranking the Top 5 trending items for rapid cashier throughput.
...
- **🗺️ Interactive Floor Plan**: Dynamic drag-and-drop table management for real-time occupancy tracking.
...
---
*Developed with excellence for THE M&G's RESTAURANT.*